---
name: kubectl-basics
description: Use for basic read-oriented kubectl usage, explicit context and namespace selection, structured output, and safe command patterns for Kubernetes inspection.
---
