...
description: Use when coordinating a technology incident response — severity classification, timeline reconstruction, stakeholder communication, and post-incident review (PIR / RCA). A structured SRE incident-command framework covering detection → triage → resolution → postmortem.
version: 1.0.0
platforms: [linux, macos, windows]
environments: [observability]
metadata:
  hermes:
    tags: [incident, commander, sre, devops, response, postmortem, rca, pir, observability]
    source: "seaworld008/Commonly-used-high-value-skills · skills/devops-sre/incident-commander"
