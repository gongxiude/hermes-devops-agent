...
| 主题 | 官方文档 | 本仓库落点 |
|---|---|---|
| Profiles | https://hermes-agent.nousresearch.com/docs/user-guide/profiles | `profile` 被定义为运行时硬边界，独立持有 `config.yaml`、`.env`、`SOUL.md`、skills、cron、gateway state。对应 `shared-skills/devops/profiles/observability-query.yaml` 和 distribution。 |
