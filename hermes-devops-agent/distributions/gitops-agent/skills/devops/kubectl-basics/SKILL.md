...
metadata:
  ...
  hermes:
    tags: [kubectl, kubernetes, basics, cli, readonly]
    related_skills: [k8s-readonly-tool, kubernetes-object-basics, kubernetes-debug]
version: 1.0.0
platforms: [linux, macos, windows]
environments: [observability-query, software-delivery-query, incident-triage]
