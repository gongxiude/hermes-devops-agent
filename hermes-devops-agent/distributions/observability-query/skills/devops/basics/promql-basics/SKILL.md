---
name: promql-basics
description: Use for PromQL selectors, range windows, rate and increase semantics, bounded query construction, and safe metric aggregation in read-only observability workflows.
---
