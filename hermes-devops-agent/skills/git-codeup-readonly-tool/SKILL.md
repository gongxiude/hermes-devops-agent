...
metadata:
  hermes:
    ...
    related_skills: [codeup-basics, git-workspace-draft-tool, gitops-mr-draft]
---
...
- `git-codeup:codeup_create_change_request` only in `software-delivery-draft`, after the source branch has been pushed through `git-workspace`.
