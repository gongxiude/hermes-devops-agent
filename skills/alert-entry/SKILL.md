---
name: alert-entry
description: Use after the observability profile has already been selected to normalize an incoming alert webhook payload (Alertmanager/Grafana/Cloud Monitor) into a structured inspection request.
version: 1.0.0
